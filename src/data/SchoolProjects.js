export const schoolProjects = [
  {
    title: "Bohnanza",
    features: [
      "Modified 2-Player Ruleset with a shared Offer Area (no trading between players) and both players’ hands visible for added strategy.",
      "Streamlined GUI Design using counters to represent piles of identical bean cards (saves space while keeping counts accurate).",
      "Interactive Player Areas with bean fields, coin counters, and purchaseable third field, plus deck/discard displays and turn indicators.",
      "Comprehensive Deck System with shuffling, re-shuffling from discard, card drawing, and tracking of deck/discard sizes.",
      "Smart Computer AI Opponent with scalable difficulty: Basic AI: plants matching beans, harvests least profitable fields. Intermediate AI: evaluates hand/offer synergy and opponent’s visible cards for better decisions."
    ],
    techStack: ["Java", "Java Swing", "JavaFX", "OOP"],
    images: [
      "/school_project_images/bohnanza1.png",
      "/school_project_images/bohnanza2.png",
      "/school_project_images/bohnanza3.png"
    ],
    links: {
      github: "https://github.com/Anahat07/Bohnanza",
    }
  },
  {
  ...
  },
  {
    title: "PitchPerfect",
    features: [
      "PDF File Upload & Parsing: Users can upload pitch documents (PDF) for automated content extraction and evaluation.",
      "SWOT-Based Assessment: Applies a structured framework to identify strengths, weaknesses, opportunities, and threats in the pitch.",
      "Rule-Based “AI-Like” Scoring: Uses heuristic checks (clarity, structure, persuasiveness, keyword frequency) to simulate intelligent analysis.",
      "Automated Feedback Reports: Generates tailored insights highlighting what works well and what needs improvement.",
      "Java GUI Interface: Intuitive interface for uploading PDFs, running analysis, and viewing feedback results.",
      "Extensible Framework: Modular design enables adding new evaluation categories or integrating future AI/ML models.",
      "Practical Use Case: Helps students, entrepreneurs, and professionals refine pitch decks through structured, automated analysis."
    ],
