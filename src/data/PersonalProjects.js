export const personalProjects = [
  {
    ...
    features: [
      "Terminal-style design theme with interactive command-inspired UI elements",
      "Gamified experiences including a basketball mini-game with physics, scoring, and leaderboard",
      "Interactive road timeline to showcase experiences, featuring animated car, progress bar, and scroll-triggered animations",
      "Dynamic dark/light mode support across all pages for accessibility and modern UI feel",
      "Smooth animations and transitions (fade-ins, hover effects, swaying net, spinning wheels) enhancing user engagement",
      "Integrated contact system with clickable commands (git clone, mail -s) and resume download",
      "Responsive, mobile-friendly layout built with React + Tailwind for seamless cross-device performance"
    ],
    techStack: ["React", "Tailwind CSS", "JavaScript", "Github", "Vercel"],
    images: [
      "/personal_project_images/website1.png",
      "/personal_project_images/website2.png",
      "/personal_project_images/website3.png",
      "/personal_project_images/website4.png",
      "/personal_project_images/website5.png",
      "/personal_project_images/website6.png",
      "/personal_project_images/website7.png",
