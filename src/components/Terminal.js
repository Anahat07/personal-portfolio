            ...
            >
              ...
              >
                ...
                <div className="flex-1 sm:pr-6">
                  <p className="text-green-300 dark:text-[#566246] flex items-center gap-2">
      <a
    ...
    className="
      ...
      sepia-100 hue-rotate-[85deg] saturate-[400%] brightness-[0.85]
      dark:sepia-0 dark:hue-rotate-0 dark:saturate-100 dark:brightness-[0.55]
    "
  />
      </a>
      ...
      <span className="ml-2">
        visitor@anahatscorner:~$ welcome
                  ...
                  <p className="dark:text-[#566246]">
                    ...
                    ,{" "}
                    <a href="https://drive.google.com/file/d/1sJwRKdLZjwK6RoqwK1INneSc7-8DqxLZ/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-blue-300 dark:text-[#0051A8] hover:underline">
                      Download Resume
                    </a>
                  </p>
                  <br />
