                ...
                const ContactPage = () => {
                  ...
                  const contactLinks = [
                    ...
                    { icon: <Download className="w-5 h-5" />, label: 'Resume', url: 'https://drive.google.com/file/d/1sJwRKdLZjwK6RoqwK1INneSc7-8DqxLZ/view?usp=sharing', command: 'curl -O /path/to/resume.pdf' }
                  ];
    ...
    className="
      ...
      filter dark:filter-none
      brightness-0 invert-0 sepia-100 saturate-500 hue-rotate-90
    "
  />
          </a>
