  ...
  <div className="flex items-center justify-center gap-3 mb-3 font-mono text-sm">
    <a
      ...
      className="text-white dark:text-black opacity-70 hover:opacity-100 transition"
    >
      ←
    </a>
    ...
    <a
      ...
      className="
        ...
        bg-[#383E30] dark:bg-background-light
        text-white dark:text-black
        border border-gray-200 dark:border-[#383E30]
        hover:bg-background-light hover:text-[#383E30]
        dark:hover:bg-[#383E30] dark:hover:text-white
