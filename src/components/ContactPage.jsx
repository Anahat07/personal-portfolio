    ...
    const ContactPage = () => {
      ...
      <div className="flex items-center justify-center gap-3 mb-3 font-mono text-sm text-green-400">
    <a
      href="https://cs.uwatering.com/#YOUR_SITE_URL?nav=prev"
    ...
    <a
      href="https://cs.uwatering.com/#YOUR_SITE_URL"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="CS Webring"
      className="flex items-center gap-2 px-2 py-1 rounded border border-green-500/40 hover:border-green-400 hover:shadow-[0_0_8px_rgba(34,197,94,0.35)] transition"
    >
      <img
        src="https://cs.uwatering.com/icon.white.svg"
        alt="CS Webring"
        className="w-5 opacity-90"
      />
      <span className="tracking-tight">cs webring</span>
    </a>

    <a
      href="https://cs.uwatering.com/#YOUR_SITE_URL?nav=next"
      className="hover:text-green-300 transition"
